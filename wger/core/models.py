...
and make the search difficult.'''),
    ...
    workout_reminder = IntegerField(
        ...
        help_text=_('The number of days '
    ...
    timer_pause = IntegerField(
        verbose_name=_('Default duration of '
                       'workout pauses'),
        help_text=_('Default duration in seconds of '
                    'pauses used by '
    ...
    sleep_hours = IntegerField(
        ...
        help_text=_('The average hours of '
                    'sleep per day'),
        default=7,
        blank=False,
        null=True,
    ...
    num_days_weight_reminder = models.IntegerField(
        verbose_name=_('Automatic reminders '
                       'for weight entries'),
        help_text=_('Number of days after the '
                    'last weight entry (enter '
                    '0 to deactivate)'),
...
class License(models.Model):
    ...
    full_name = models.CharField(
        ...
        help_text=_('If a license has been '
                    'localized, e.g. the Creative '
                    'Commons licenses for '
                    'the different countries, add '
                    'them as separate entries here.'))
    '''Full name'''

    short_name = models.CharField(
        max_length=15, verbose_name=_('Short name, '
                                      'e.g. CC-BY-SA 3'))
