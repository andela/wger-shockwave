...
class UserEmailForm(forms.ModelForm):
    ...
    def clean_email(self):
        ...
        However, this check should only be performed
        when the user changes his email, otherwise
        the uniqueness check will because it will find one user
...
class RegistrationForm(UserCreationForm, UserEmailForm):
    ...
    # only on wger.de, perhaps because there the application is behind
    # a reverse proxy. See  #281.
