...
class Muscle(models.Model):
    ...
    def delete(self, *args, **kwargs):
        ...
        exercise_group = Exercise.objects.filter(muscles=self).iterator()
...
class Exercise(AbstractSubmissionModel, AbstractLicenseModel, models.Model):
    ...
    def send_email(self, request):
        '''
        Sends an email after being successfully added to the database
        ...
        if self.license_author and user.email:
            ...
            subject = _('Exercise was successfully added '
...
class ExerciseImage(AbstractSubmissionModel, AbstractLicenseModel,
    ...
    is_main = models.BooleanField(
        ...
        help_text=_("Tick the box if you want to set "
                    "this image as the main one for "
                    "the exercise (will be shown e.g. in "
                    "the search). The first image "
