...
class Command(BaseCommand):
    ...
    help = ('Download exercise images from wger.de and '
            'update the local database\n'
            '\n'
            'ATTENTION: The script will download the images '
            'from the server and add them\n'
            '           to your local exercises. '
            'The exercises are identified by\n'
            '           their UUID field, '
            'if you manually edited or changed it\n'
        ...
        for exercise_json in result['results']:
            ...
            if images['count']:
                ...
                for image_json in images['results']:
                    ...
                    self.stdout.write('    Fetching image {0} - {1}'.format(image_id,
                                                                            image_name))
